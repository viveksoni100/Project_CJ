...
@Getter
@Setter
public class OCRPurchaseSuccessEvent extends ApplicationEvent implements BaseEvent {
     ...
     */
    public OCRPurchaseSuccessEvent(User daasUser, Order order, OrderDetail orderDetail, List<OrderDetail> orderDetailList) {
        super(daasUser);
