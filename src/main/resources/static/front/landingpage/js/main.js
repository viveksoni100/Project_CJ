$(function() {
    ...
    $(window).on('scroll', function (event) {
        ...
        if (scroll < 20) {
            ...
            /*$(".loginbutton").addClass("btn-outline-light");
            $(".loginbutton").removeClass("btn-outline-dark");*/
            //$(".navbar-area img").attr("src", "/front/landingpage/images/logo_global_trade.png");
        } else {
            $(".navbar-area").addClass("sticky");
            /*$(".loginbutton").addClass("btn-outline-dark");
            $(".loginbutton").removeClass("btn-outline-light");*/
            //$(".navbar-area img").attr("src", "/front/landingpage/images/logo_global_trade.png");
        }
    });
