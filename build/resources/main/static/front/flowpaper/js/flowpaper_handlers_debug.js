...
function chainOfMethods() {
    ...
    viewer.addMark({
        type: 'note',
        note: 'The annotations plug-in allows both highlighting and notes to be created\n\nNotes can be resized, moved and deleted.',
        positionX: -5,
        positionY: 330,
        width: 200,
        height: 180,
    ...
    viewer.addMark({
        type: 'note',
        note: 'The plug-in features a full set of API functions which can be used to interact with the viewer so that annotations can be stored and recreated later.',
        positionX: 530,
        positionY: 150,
        width: 200,
        height: 180,
